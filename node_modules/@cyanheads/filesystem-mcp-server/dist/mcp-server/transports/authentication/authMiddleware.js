...
if (environment === "production" && !config.mcpAuthSecretKey) {
    const error = new Error("CRITICAL: MCP_AUTH_SECRET_KEY must be set in production environment for JWT authentication.");
...
export function mcpAuthMiddleware(req, res, next) {
    ...
    try {
        ...
        if (error instanceof jwt.TokenExpiredError) {
            ...
            logger.error("Authentication failed: Unexpected non-error exception during token verification.", { ...context, error: String(error) });
        }
