...
import { WriteFileInputSchema, writeFileLogic, } from './writeFileLogic.js';
/**
 ...
 */
export const registerWriteFileTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('write_file', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => writeFileLogic(typedParams, callContext), {
