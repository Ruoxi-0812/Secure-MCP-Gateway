...
import { ReadFileInputSchema, readFileLogic } from './readFileLogic.js';
/**
 ...
 */
export const registerReadFileTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        ...
        server.tool('read_file', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => readFileLogic(typedParams, callContext), // Use typedParams
            {
