...
import { ListFilesInputSchema, listFilesLogic } from './listFilesLogic.js';
/**
 ...
 */
export const registerListFilesTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('list_files', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => listFilesLogic(typedParams, callContext), {
