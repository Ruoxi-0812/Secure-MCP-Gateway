...
import { DeleteFileInputSchema, deleteFileLogic } from './deleteFileLogic.js';
/**
 ...
 */
export const registerDeleteFileTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('delete_file', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => deleteFileLogic(typedParams, callContext), {
