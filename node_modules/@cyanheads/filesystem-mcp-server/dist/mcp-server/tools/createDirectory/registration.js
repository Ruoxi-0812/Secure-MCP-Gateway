...
import { CreateDirectoryInputSchema, createDirectoryLogic } from './createDirectoryLogic.js';
/**
 ...
 */
export const registerCreateDirectoryTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('create_directory', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => createDirectoryLogic(typedParams, callContext), {
