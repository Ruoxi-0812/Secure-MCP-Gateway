...
import { CopyPathInputSchema, copyPathLogic } from './copyPathLogic.js';
/**
 ...
 */
export const registerCopyPathTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('copy_path', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => copyPathLogic(typedParams, callContext), {
