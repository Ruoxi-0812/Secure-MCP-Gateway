...
import { MovePathInputSchema, movePathLogic } from './movePathLogic.js';
/**
 ...
 */
export const registerMovePathTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('move_path', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => movePathLogic(typedParams, callContext), {
