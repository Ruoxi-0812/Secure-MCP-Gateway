...
import { UpdateFileInputSchema, updateFileLogic } from './updateFileLogic.js';
/**
 ...
 */
export const registerUpdateFileTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('update_file', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => updateFileLogic(typedParams, callContext), {
