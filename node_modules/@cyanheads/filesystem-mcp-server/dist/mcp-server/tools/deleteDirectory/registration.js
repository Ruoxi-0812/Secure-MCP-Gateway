...
import { DeleteDirectoryInputSchema, deleteDirectoryLogic } from './deleteDirectoryLogic.js';
/**
 ...
 */
export const registerDeleteDirectoryTool = async (server) => {
    ...
    await ErrorHandler.tryCatch(async () => {
        server.tool('delete_directory', // Tool name
        ...
        async (params, extra) => {
            ...
            const result = await ErrorHandler.tryCatch(() => deleteDirectoryLogic(typedParams, callContext), {
